...
namespace Vista.Controllers
{
    public class MatrizController : Controller
    {
        ...
        [HttpPost]
        public JsonResult vector(string matriz)
        {
            Modelo.Resultado resultado = new Modelo.Resultado();
            ...
            try
            {
                ...
                {
                    cliente.BaseAddress = new Uri(urlAPI);
                    var peticion = cliente.PostAsync($"Matriz/mat-vector/{matriz}", null);
                    peticion.Wait();
        ...
        public IActionResult Pascal()
        {
            return View();
        }

        [HttpPost]
        public JsonResult pascal(int rango)
        {
            Modelo.Resultado resultado = new Modelo.Resultado();
            ...
            try
            {
                ...
                {
                    cliente.BaseAddress = new Uri(urlAPI);
                    var peticion = cliente.PostAsync($"Matriz/mat-pascal/{rango}", null);
                    peticion.Wait();
